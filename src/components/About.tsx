          ...
          <div className="prose max-w-none col-span-12 md:col-span-10 overflow-hidden min-w-0">
            ...
            */}
            ...
            <ul>
                ...
                <li>Founded and captained rakuz4n, a CTF team consisting of players from teams from all across the world, with the intent on creating a friendly enviroment for collective learning and individual growth.</li>
                <li>Closely worked with private security researchers and veteran red teamers on the topics of penetration testing and malware development, where we specifically worked on innovative methods to extract SSNs without relying on incrementation and parsing the NTDLL.dll along with anti-sandbox techniques. One of our biggest researches was the attempted identification and termination of all PatchGuard threads, in order to allow tampering with critical kernel structures, which as a result would drastically simplify the process of developing bootkits/rootkits.</li>
                ...
                <li>Participated in cybersecurity competitions hosted by Binary Confidence - where I was elected the MVP of my team due to leadership skills, team contribution and coordination. Learned valuable and hands on skills from the areas of digital forensics, proactive and reactive incident response along with threat hunting.</li>
                <li>Placed in the top 10 of CyberGame 2025 - the national qualifier for Team Slovakia</li>
            </ul>
          </div>
        </div>
        <Footer />
